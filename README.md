...
* cd <начало слова> +Tab - сработает автозаполнение
...
- untracked - нет предыдущих версий, зафиксированных в коммитах или через команду git add  

- staged - файл после git add попадает в staging area (список файлов, которые войдут в коммит)  
...
graph LR;
  ...
  staged/tracked    -- "git commit"     --> tracked/committed;
  tracked/committed   -- edit     --> modified;
